...
- Use `/validate-ghcr-upgrade` when the question is whether a new fork image is safe to publish or consume, or whether local pins can move from fork GHCR to upstream GHCR.
